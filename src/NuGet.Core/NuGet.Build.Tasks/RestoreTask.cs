...
namespace NuGet.Build.Tasks
{
    ...
    public class RestoreTask : Task
    {
        ...
        /// <summary>
        /// Restore all projects in the closure instead of the entry point(s).
        /// </summary>
        ...
        public override bool Execute()
        {
            ...
            log.LogDebug($"(in) RestoreRecursive '{RestoreIgnoreFailedSources}'");
            ...
            using (var cacheContext = new SourceCacheContext())
            {
                ...
                // Add all child projects if --recursive is set
                if (RestoreRecursive)
                {
                    dgFile.AddRestoreForAllProjects();
                }
